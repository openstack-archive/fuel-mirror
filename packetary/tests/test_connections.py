...
class TestConnectionManager(base.TestCase):
    ...
    def test_redirections(self, logger, http_open):
        ...
        self.assertIsInstance(http_open.call_args_list[2][0][0], connections.RetryableRequest)
        self.assertEqual(http_open.call_args_list[2][0][0].get_full_url(), 'http://127.0.0.1')
