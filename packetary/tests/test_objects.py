...
class TestPackageVersion(base.TestCase):
    def test_get_from_string(self):
        ver = PackageVersion.from_string("1.0-2")
        self.assertEqual(0, ver.epoch)
        self.assertEqual(('1', '0'), ver.version)
        self.assertEqual(('2',), ver.release)

        ver2 = PackageVersion.from_string("1-1.0-2")
        self.assertEqual(1, ver2.epoch)
        self.assertEqual(('1', '0'), ver2.version)
        self.assertEqual(('2',), ver2.release)

    def test_compare(self):
        ver1 = PackageVersion.from_string("1.0-2.1")
        ver2 = PackageVersion.from_string("1.0-2.2")
        self.assertLess(ver1, ver2)
        self.assertGreater(ver2, ver1)
        self.assertEqual(ver1, ver1)
        self.assertLess(ver1, "1.0-2.3")
        self.assertGreater(ver1, "1.0-2")
