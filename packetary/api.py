...
class RepositoryApi(object):
    ...
    def get_packages(self, origin, debs=None, bootstrap=None):
        """Gets the list of required packages from repository(es).

        :param origin: the list of URLs of repositories
                       or single URL of repository for copying
        :param debs: the list of URLs of repositories
                     or URL of repository to calculate minimal set
                     of required packages
        :param bootstrap: the list of additional packages, that is mandatory.
    ...
    def clone_repositories(self, origin, destination, debs=None,
        ...
        :param origin: the list of URLs of repositories
                       or URL of repository for copying
        :param debs: the list of URLs of repositories
                     or URL of repository to calculate minimal set
                     of required packages
        :param bootstrap: the list of additional packages, that is mandatory.
        ...
        :param include_source: if True, the source packages will be copied as well.
    ...
    def get_unresolved_dependencies(self, urls):
        ...
        :param urls: the list of URLs of repositories or URL of repository
