...
class Repository(object):
    ...
    def __eq__(self, other):
        """Checks that repositories is equal.

        Note: the URL is not included because
        two repositories in different places may be same.
        for example: one is clone of other.
        """
