...
class Package(object):
    ...
    def get_replaces(self):
        """Gets the packages that replaced by this."""
...
class Repository(object):
    ...
    def add(self, package):
        ...
        for r, v in package.get_replaces():
            self.packages[r][v] = package
        for p, v in package.get_provides():
            self.packages[p][v] = package
