...
def main():
    ...
    # details: http://galaxy-dist.readthedocs.org/en/latest/lib/pkg_resources.html
    ...
    for part in pip_ver_parts:
       ...
       if re.match(r"[*a-z]",part):
           ...
           continue
       if _ver:
           pkg_ver_part.append(re.sub(r"^(0+)([0-9]+)", r"\2", part))
       else:
           pkg_rev_part.append(re.sub(r"^(0+)([0-9]+)", r"\2", part))
