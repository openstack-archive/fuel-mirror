...
main() {
    ...
    if [ "${IS_UPDATES}" = 'true' ] ; then
        ...
        if [ -z "${DEB_PROPOSED_DIST_NAME}" ] ; then
        ...
        if [ -z "${DEB_PROPOSED_COMPONENT}" ] ; then
    ...
    if [ "${IS_HOLDBACK}" = 'true' ] ; then
        ...
        # It's possible to provide another distribution name for package
        if [ -z "${DEB_HOLDBACK_DIST_NAME}" ] ; then
        ...
        # It's possible to provide another component name for package
        if [ -z "${DEB_HOLDBACK_COMPONENT}" ] ; then
    ...
    if [ "${IS_SECURITY}" = 'true' ] ; then
        ...
        # It's possible to provide another distribution name for package
        if [ -z "${DEB_SECURITY_DIST_NAME}" ] ; then
        ...
        # It's possible to provide another component name for package
        if [ -z "${DEB_SECURITY_COMPONENT}" ] ; then
