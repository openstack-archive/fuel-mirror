...
class TestCliCommands(base.TestCase):
    ...
    def start_cmd(self, cmd, argv):
        cmd.debug([DATA_PATH] + argv + self.common_argv)
    ...
    def test_create_mos_ubuntu(self, accessors):
        ...
        self.start_cmd(create, ["--repository", "mos"])
        ...
        api.clone_repositories.assert_called_once_with(
            ...
            '/var/www/nailgun/mirrors/mos/ubuntu',
            None, None
        )
    ...
    def test_create_partial_ubuntu(self, accessors):
        ...
        self.start_cmd(create, ["--repository", "ubuntu"])
        accessors.get_packetary_accessor.assert_called_with(
            threads_num=1,
            ignore_errors_num=2,
            retries_num=3,
        ...
        api = packetary()
        api.clone_repositories.assert_called_once_with(
            ['http://localhost/mos trusty '
             'main multiverse restricted universe'],
            '/var/www/nailgun/mirrors/ubuntu',
            ['http://localhost/mos mos1 main restricted'],
            ['package1']
        )
    ...
    def test_create_mos_centos(self, accessors):
        ...
        self.start_cmd(create, ["--repository", "mos_centos"])
        accessors.get_packetary_accessor.assert_called_with(
            threads_num=1,
            ignore_errors_num=2,
            retries_num=3,
        ...
        api.clone_repositories.assert_called_once_with(
            ['http://localhost/mos1'],
            '/var/www/nailgun/mirrors/mos_centos/centos',
            None, None
        )
    ...
    def test_create_partial_centos(self, accessors):
        ...
        self.start_cmd(create, ["--repository", "centos"])
        accessors.get_packetary_accessor.assert_called_with(
            threads_num=1,
            ignore_errors_num=2,
            retries_num=3,
        ...
        api.clone_repositories.assert_called_once_with(
            ...
            '/var/www/nailgun/mirrors/centos',
            ['http://localhost/mos1'],
            None
        )
            ...
            {'editable': {'repo_setup': {'repos': {'value': [
                {
                    ...
                    'type': 'deb',
                    'uri': 'http://10.25.0.10:8080/mirrors/mos/ubuntu'
                },
                {
                    'priority': 500,
                    'name': 'ubuntu',
                    ...
                    'type': 'deb',
                    'uri': 'http://10.25.0.10:8080/mirrors/ubuntu'
                }
            ]}}}}
        )
            ...
            {'editable': {'repo_setup': {'repos': {'value': [
                {
                    ...
                    'name': 'centos',
                    'type': 'rpm',
                    'uri': 'http://10.25.0.10:8080/mirrors/centos/os/x86_64'
                },
                {
                    'priority': 1000,
                    'name': 'mos',
                    ...
                    'uri': 'http://10.25.0.10:8080'
                           '/mirrors/mos_centos/centos/mos1/x86_64'
                }]
            }}}}
        )
